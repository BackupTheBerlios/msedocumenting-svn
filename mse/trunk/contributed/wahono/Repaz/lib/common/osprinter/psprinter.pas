...
{           PostScript file printer for OSPrinter         }
{                                                         }
{          Originally file is msepostscriptprinter        }
...
uses
 ...
 msedrawtext,mserichstring,osprinter,osprinterstype,msewidgets,msefloattostr;
...
begin
 postscriptgcty(drawinfo.gc.platformdata).canvas.handleellipse(drawinfo.rect.rect^,false);
end;
...
begin
 postscriptgcty(drawinfo.gc.platformdata).canvas.handleellipse(drawinfo.rect.rect^,true);
end;
...
begin
 ...
 result[26].name:= 'Folio';     result[26].width:=    210; result[26].height:=   330;result[26].paperindex:= 26;
 result[27].name:= 'Ledger';    result[27].width:=    432; result[27].height:=   279;result[27].paperindex:= 27;
 result[28].name:= 'Legal';     result[28].width:=    216; result[28].height:=   356;result[28].paperindex:= 28;
 result[29].name:= 'Letter';    result[29].width:=    216; result[29].height:=   279;result[29].paperindex:= 29;
 result[30].name:= 'Tabloid';   result[30].width:=    279; result[30].height:=   432;result[30].paperindex:= 30;
end;
